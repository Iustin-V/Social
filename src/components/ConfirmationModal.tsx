...
export default function ConfirmationModal(props:{open:boolean,setOpened:any,confirmHandle:any}) {
                                        ...
                                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                            ...
                                            <div className="mt-2">
                                                <p className="text-sm text-gray-500">
                                                    Are you sure you want to delete it? This data will be permanently
