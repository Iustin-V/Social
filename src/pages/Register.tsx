              ...
              <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                ...
                <div className=" my-4 md:my-0">
                  <p className="mx-auto max-w-screen-md text-center text-black md:text-lg">
                    Welcome to RedEclipseNET! We are excited to have you with us
                    and offer you an unforgettable social experience. Register
                    now to join our growing community and start your adventure
                    on RedEclipseNET.
                  </p>
                </div>
              </div>
                  ...
                  <div className="flex flex-col p-4 md:p-8">
                    ...
                    <div className="relative pb-8 md:pb-4">
                      ...
                      {passwordError && (
                        <p
                          className={
                            "absolute bottom-0 md:bottom-1 text-red-500"
                          }
                        >
                          {passwordError}
                        </p>
